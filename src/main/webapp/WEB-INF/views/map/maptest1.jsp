...
<body>
	...
	<div class="modal fade" id="addressModal" tabindex="-1" aria-labelledby="addressModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg"> <!-- 모달 크기를 키움 -->
			<div class="modal-content">
				...
				<div class="modal-body">
					<div id="postcode"></div> <!-- 여기에 Daum Postcode API가 삽입됨 -->
				</div>
			</div>
		</div>
	</div>
	...
	<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=8bcb92e8b96f5a06c65f1c0e5308b488&libraries=services"></script>
	<script>

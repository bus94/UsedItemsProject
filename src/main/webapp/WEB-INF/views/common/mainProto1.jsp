...
<body>
	...
	<div id="pageContainer" class="container">
		...
		<!-- Header&Navi -->
		<nav
			class="navbar navbar-expand-lg bg-body-tertiary fixed-top bg-success-subtle">
		...
		<div id="carouselExampleAutoplaying" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="${path}/resources/img/item4.png" class="d-block w-100"
						alt="...">
				</div>
				<div class="carousel-item">
					<img src="${path}/resources/img/item5.png" class="d-block w-100"
						alt="...">
				</div>
				<div class="carousel-item">
					<img src="${path}/resources/img/item2.png" class="d-block w-100"
						alt="...">
				</div>
			</div>
		...
		<div id="categories" class="container w-100 mt-5 mb-5">
            <h2 class="categ_title">Categories</h2>
              <ul class="majors">
                <li id="veggies" class="major">
                    <i class="fa-solid fa-shirt"></i>
                    <p class="major_title">상의</p>
                </li>
                <li id="meat" class="major">
                    <i class="fa-solid fa-socks"></i>
                    <p class="major_title">하의</p>
                </li>
                <li id="seafood" class="major">
                    <i class="fa-solid fa-shoe-prints"></i>
                    <p class="major_title">신발</p>
                </li>
                <li id="seafood" class="major">
                    <i class="fa-solid fa-glasses"></i>
                    <p class="major_title">기타의류</p>
                </li>
                <li id="seafood" class="major">
                   	<i class="fa-solid fa-wallet"></i>
                    <p class="major_title">지갑</p>
                </li>
                <li id="seafood" class="major">
                    <i class="fa-solid fa-jet-fighter-up"></i>
                    <p class="major_title">피규어</p>
                </li>
                <li id="seafood" class="major">
                    <i class="fa-solid fa-camera-retro"></i>
                    <p class="major_title">전자기기</p>
                </li>
                <li id="seafood" class="major">
                    <i class="fa-solid fa-chair"></i>
                    <p class="major_title">가구</p>
                </li>
                <li id="seafood" class="major">
                    <i class="fa-solid fa-cheese"></i>
                    <p class="major_title">식품</p>
                </li>
                <li id="seafood" class="major">
                    <i class="fa-regular fa-lightbulb"></i>
                    <p class="major_title">기타</p>
                </li>                
            </ul>
        </div><!-- category viewer -->
		<div>

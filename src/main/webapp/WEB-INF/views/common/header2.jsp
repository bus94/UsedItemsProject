			...
			<div id="nav_container" class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-lg-0">
						...
						<a class="nav-link active" aria-current="page" href="${path}/item/itemList2.do">
							<li class="nav-item">
								<img class="nav_icon" alt="매물 검색" src="${path}/resources/img/shop.png">
								<span class="menu_text">매물검색테스트</span>
							</li>
						</a>
					...
					<form class="d-flex" role="search" action="${path}/item/itemList2.do" method="get">
						<input
						...
						<button class="btn btn-outline-success" type="submit">테스트</button>
					</form>

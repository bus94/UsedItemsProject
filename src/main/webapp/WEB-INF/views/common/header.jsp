...
<body>
	...
	<header>
		<div class="login-container">
			...
			<div class="login"  style="width: 200px;  justify-content: space-between;">
				<div class="login_btn" style="margin-right: 20px;">
					<img alt="로그인" src="${path}/resources/img/login.png">
					<a href="${path}/account/login.do">로그인</a>
				</div>
				<div class="login_btn">
					<img alt="회원가입" src="${path}/resources/img/login2.png">
					<a href="#">회원가입</a>
				</div>
			</div>
		</div>
